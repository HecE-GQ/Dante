...
<div id="page-wrapper">
    ...
    <nav id="nav">
				<div class="container">
					<ul>
						...
						<li><a href="#">Convocatoria SIDEPAAE</a></li>
  ...
  <footer id="footer">
      ...
      <div class="container footer-inner">
        ...
        <div class="footer-col">
          ...
          <p class="footer-address">
            Circuito exterior s/n, frente a la Facultad de Contaduría y Administración,
        ...
        <div class="footer-col footer-social-col">
          <ul class="footer-social">
            ...
            <li><a href="#" aria-label="X"><i class="icon brands fa-x-twitter"></i></a></li>
    ...
    <div class="footer-bottom">
      <p>Hecho en México. Universidad Nacional Autónoma de México (UNAM). Todos los derechos reservados 2025.</p>
    </div>
  </footer>
